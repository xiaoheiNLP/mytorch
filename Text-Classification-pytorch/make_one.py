...
vocab_path = r'D:\myProject\mytorch\Text-Classification-pytorch\THUCNews\data\vocab.pkl'
train_path = r'D:\myProject\mytorch\Text-Classification-pytorch\THUCNews\data\train.txt'
pad_size = 32
dev_path = r'D:\myProject\mytorch\Text-Classification-pytorch\THUCNews\data\dev.txt'
test_path = r'D:\myProject\mytorch\Text-Classification-pytorch\THUCNews\data\test.txt'
...
def test(test_iter):
    ...
    model = TextCNN.Model(config).to('cuda')
    model.load_state_dict(torch.load(r'D:\myProject\mytorch\Text-Classification-pytorch\THUCNews\saved_dict\TextCNN.ckpt'))
    model.eval()
...
def show_bert():
    ...
    bert_tokenizer = BertTokenizer.from_pretrained(r'D:\myProject\mytorch\Bert-Text-Classification-pytorch\bert_pretrain')
    a = "我是祝鑫泉"
    ...
    bert_model = BertModel.from_pretrained(r'D:\myProject\mytorch\Bert-Text-Classification-pytorch\bert_pretrain').to('cuda')
